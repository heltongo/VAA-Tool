...
class MainWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.timeButton.Bind(wx.EVT_BUTTON, self.timesButton)
        ...
        self.keywordButton = wx.Button(pnl, pos=(10, 180), label="Accident by Keyword Analysis")
        self.keywordButton.Bind(wx.EVT_BUTTON, self.keywordsButton)

        self.alcoholButton = wx.Button(pnl, pos=(10, 200), label="Alcohol Impact Analysis")
        self.alcoholButton.Bind(wx.EVT_BUTTON, self.alcoholsButton)

        self.geographicButton = wx.Button(pnl, pos=(10, 230), label="Geographic Impact Analysis")
        self.geographicButton.Bind(wx.EVT_BUTTON, self.geosButton)
...
#         # self.panel5 = Panel5(self)
    ...
    def keywordsButton(self, event):
        self.frame.Show()
        self.Hide()

    def alcoholsButton(self, event):
        self.frame.Show()
        self.Hide()

    def geosButton(self, event):
        self.frame.Show()
        self.Hide()
